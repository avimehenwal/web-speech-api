...
import { WaveBars, FieldLabel, StyledSelect, Btn } from './UI'
...
export default function SRPanel() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      {!supported && (
        <div style={{
          padding: '14px 18px', borderRadius: 8, fontSize: '.8rem', lineHeight: 1.65,
          background: 'rgba(248,113,113,.08)', border: '1px solid rgba(248,113,113,.25)',
          color: 'var(--red)',
        }}>
          <strong>Not supported.</strong> SpeechRecognition requires Chrome, Edge, or Safari.
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 16, alignItems: 'end' }}>
        ...
        <label style={{
          ...
          paddingBottom: 10, whiteSpace: 'nowrap',
      ...
      {/* Mic button */}
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 20, padding: '4px 0' }}>
      ...
      <div>
        ...
        <div style={{
          minHeight: 130, background: 'var(--bg)',
          border: '1px solid var(--border)', borderRadius: 8,
          padding: '14px 16px', fontSize: '.88rem', lineHeight: 1.75,
          color: 'var(--text)', overflowY: 'auto', maxHeight: 220,
          ...
          {interim && (
            <span style={{ color: 'var(--muted)', fontStyle: 'italic' }}>{interim}</span>
          )}
        </div>
      </div>
